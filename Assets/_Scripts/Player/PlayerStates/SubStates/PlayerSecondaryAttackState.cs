...
//     public PlayerSecondaryAttackState(Player player, PlayerStateMachine playerStateMachine, PlayerData playerData,string animBoolName, Weapon weapon) : base(player, playerStateMachine, playerData,animBoolName)
//     {
//         this.weapon = weapon;
